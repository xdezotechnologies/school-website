            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="blog-post d-flex pt-3">
                        <p class="mr-3"><i class="fa fa-calendar mr-1"></i> March 13,2019</p>
                        <p class="mr-3"><i class="fa fa-comments mr-1"></i> 10 comments</p>
                    </div>
                    <div class="blog-title">
                        <h4 class="font-weight-bold mb-3">Contrary to popular belief, Lorem Ipsum is not simply random text.
                            It has roots in a piece of classical</h4>
                    </div>
                    <div class="blog-desc">
                    ...
                    <div class="comments">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="media p-3">
                                    <img src="assets/images/3.png" alt="John Doe" class="mr-3 rounded-circle">
                                    <div class="media-body">
                                        <div class="user d-flex justify-content-between">
                                            <h6 class="font-weight-bolder">John Doe</h6>
                                            <a href="#">Reply</a>
                ...
                <div class="col-md-4">
                    ...
                    <div class="recent-blog ">
                        ...
                        <div class="media">
                            <img src="assets/images/thumb_1.jpg" alt="John Doe" class="mr-3">
                            <div class="media-body">
                                <p class="font-weight-bold mb-2">Contrary to popular belief.Lorem Ipsum is not simply random
                                    text. </p>
                                <p>Posted on February 19, 2016</p>
                        ...
                        <div class="media">
                            <img src="assets/images/thumb_2.jpg" alt="John Doe" class="mr-3">
                            <div class="media-body">
                                <p class="font-weight-bold mb-2">Contrary to popular belief.Lorem Ipsum is not simply random
                                    text. </p>
                                <p>Posted on February 19, 2016</p>
